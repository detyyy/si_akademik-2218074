                            ...
                            <div class="row mx-2 my-2">
                                ...
                                <div class="table">
                                    ...
                                    <input type="text" name="Thn_Ajaran" id="Thn_Ajaran" class="form-control" placeholder=""
                                        aria-label="First" {{ old('Thn_Ajaran', $jadwal->Thn_Ajaran) }}>
                                </div>
                                <!-- <div class="table">
                                ...
                                <br>
                                <div class="table">
                                    <label for="id_matapel">Nama_Mapel</label>
                                    <select class="form-control" name="id_matapel" id="id_matapel">
                                        <option hidden>Pilih Mata Pelajaran</option>
                                        <option disabled="disabled" default="true">Pilih Mata Pelajaran</option>
                                        @foreach ($Nama_Mapel as $id => $item)
                                            <option value="{{ $item->id_matapel }}"
